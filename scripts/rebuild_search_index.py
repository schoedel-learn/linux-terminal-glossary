...
SEARCH_SYNONYMS = {
    ...
    # ── Spanish (bilingual queries → English commands) ───────────────
    "borrar": ["rm", "delete", "remove", "eliminar"],
    "eliminar": ["rm", "delete", "remove", "borrar"],
    "archivos": ["files", "file", "documentos"],
    "archivo": ["file", "files"],
    "carpeta": ["directory", "dir", "folder"],
    "directorio": ["directory", "dir", "folder"],
    "procesos": ["process", "processes", "ps", "top"],
    "contenedores": ["container", "containers", "docker"],
    "listar": ["list", "ls", "show"],
    "copiar": ["copy", "cp", "scp", "rsync"],
    "mover": ["move", "mv"],
    "buscar": ["search", "find", "grep", "locate"],
    "crear": ["create", "mkdir", "touch"],
    "ver": ["show", "view", "display", "list"],
    "instalar": ["install", "apt", "pip", "npm"],
    "actualizar": ["update", "upgrade"],
    "red": ["network", "networking", "ip"],
    "servidor": ["server", "remote", "ssh"],
    "disco": ["disk", "storage", "df", "du"],
    "memoria": ["memory", "ram", "free"],
    "espacio": ["space", "disk", "df", "du"],
    "permisos": ["permission", "permissions", "chmod", "chown"],
    "usuario": ["user", "users", "useradd"],
    "contrasena": ["password", "passwd"],
    "conectar": ["connect", "ssh", "nc"],
    "descargar": ["download", "wget", "curl"],
    "subir": ["upload", "push", "scp"],
    "comprimir": ["compress", "tar", "gzip", "zip"],
    "descomprimir": ["extract", "unzip", "tar", "unrar"],
    "ejecutar": ["run", "execute", "exec"],
    "correr": ["run", "execute"],
    "registros": ["logs", "log", "journalctl"],
    "monitorear": ["monitor", "watch", "top"],
    "seguridad": ["security", "secure", "firewall", "ufw"],
